...
@Entity
@Table(name = "testcase")
@NamedStoredProcedureQuery(name="chartresult",procedureName="chartresult",resultClasses=ChartDB.class,parameters= {
	@StoredProcedureParameter(mode=ParameterMode.IN,type=String.class,name="username"),
	@StoredProcedureParameter(mode=ParameterMode.OUT,type=Integer.class,name="skip"),
	@StoredProcedureParameter(mode=ParameterMode.OUT,type=Integer.class,name="pass"),
	@StoredProcedureParameter(mode=ParameterMode.OUT,type=Integer.class,name="fail")
})
public class ChartDB implements Serializable{
